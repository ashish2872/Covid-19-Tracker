...
app1.layout=html.Div([
    ...
    html.Div([
        ...
        html.Div([
            html.Div([
                html.Div([
                    dcc.Graph(id='Bubble plot',figure=fig3)
                ], className='card-body')
            ], className='card bg-dark ')
        ], className='col-md-6'),
    ], className='row'),
    html.Div([
        html.Div([
            html.Div([
                html.Div([
                    html.H3("Total number of Covid19 tests taken place in India till date", className='text-light'),
                    html.H4(ac['number'].map(int), className='text-light')
                ], className='card-body')
            ], className='card bg-info')
        ], className='col-md-6'),
        html.Div([
    ...
    html.Div([
        html.Div([
            html.Div([
                html.Div([
                    html.H6('@TEAM-TROUBLESHOOTERS', style={'color': 'grey', 'text-align': 'center'}),
                    html.H6('(AMITY SCHOOL OF ENGINEERING AND TECHNOLOGY, KOLKATA)',style={'color': 'grey', 'text-align': 'center'})
                ], className='card-body')
            ], className='card bg-dark')
        ], className='col-md-12')
    ], className='row')
